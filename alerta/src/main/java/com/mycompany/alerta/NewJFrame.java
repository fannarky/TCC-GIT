    ...
    public NewJFrame() {
        ...
        Thread alertaMemoria = new Thread(){
            ...
            public void run() {
                ...
                while(true){
                    jProgressBar1.setValue(Integer.parseInt(info.isCheiaInt(sis.getHardware().getMemory().getTotal(), sis.getHardware().getMemory().getAvailable())));
        ...
        Thread preencheBarra = new Thread(){
            @Override
            public void run() {
                while(true){
                    jProgressBar1.setValue(Integer.parseInt(info.isCheiaInt(sis.getHardware().getMemory().getTotal(), sis.getHardware().getMemory().getAvailable()))); 
